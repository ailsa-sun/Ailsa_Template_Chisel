...
```sh
git clone git@github.com:ailsa-sun/Ailsa_Template_Chisel.git
cd Ailsa_Template_Chisel
```
...
#### Commit your changes
```sh
git commit -m 'Starting Ailsa_Template_Chisel'
...
```sh
mill Ailsa_Template_Chisel.test
```
